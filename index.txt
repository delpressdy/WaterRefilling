...
//condition for step 3
    if (isset($_GET['launchapp']) && $Validation->checkEnvFileExists() === true) {
            ...
            <div class="container"> 
                ...
                <div class="row"> 
                    <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1"> 
                        <header class="header">
                            <h1 class="header-title">Install</h1>
                        </header>
                            ...
                            <div class="outer-container">
                                <div id="wizard" class="aiia-wizard">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="hidden" class="form-control" id="userid" name="userid" value="maridelerquita@gmail.com" placeholder="User ID" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                      <!--   <label for="purchase_key" class="col-sm-4 col-form-label">Purchase Key <span class="glyphicon glyphicon-question-sign" data-toggle="tooltip" data-placement="bottom" title="Enter Purchase Key which you got by envato purchase or bdtask support.">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="hidden" class="form-control" id="purchase_key" value="maridel"  name="purchase_key"  placeholder="Purchase Key" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="aiia-wizard-step <?php echo (isset($_GET['step3'])?'active':'') ?>">
                                        ...
                                        <h3 class="title text-center"><p>Database: <strong>aqualife</strong></p></h3>
                                                <input type="hidden" name="_token" value="<?= (!empty($token)?$token:null) ?>"/>
                                                <div class="form-group">
                                                    <!-- <label for="database">Database Name </label> -->
                                                    <input type="hidden" name="database" class="form-control" id="database" placeholder="Database Name" value="aqualife">
                                                </div> 
                                                <div class="form-group">
                                        ...
                                        <div class="logininfo hide" id="logininfo"> 
                                            ...
                                            <form action="index.php?step4=true" method="post" class="form-horizontal">
                                                <div class="step-content step-four">
                                                    <div class="row">
                                                        <h3 class="title text-center"><p>Username: <strong>maridelerquita@mail.com</strong></p></h3>
                                                        <h3 class="title text-center"><p>Password: <strong>maridel</strong></p></h3>
                                                        <div class="col-sm-7">
                                                            <div class="form-group">
                                                               <!--  <label for="email" class="col-sm-4 col-form-label">Email</label> -->
                                                                <div class="col-sm-8">
                                                                    <input type="hidden" name="email" class="form-control" id="email" placeholder="Email" value="maridelerquita@mail.com" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <!-- <label for="pass" class="col-sm-4 col-form-label">Password</label> -->
                                                                <div class="col-sm-8">
                                                                    <input type="hidden" name="password" class="form-control" placeholder="Password" value="maridel" id="pass" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-12">
                                               ...
                                               <!--  <div class="alert alert-success">
                                                ...
                                                <!-- <div class="text-center hide" id="btn-complete">
                                                    <a href="index.php?complete=true&launchapp=true" class="btn btn-block cbtn">Click to launch!</a>
                                                </div> -->
