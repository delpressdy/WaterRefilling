                      ...
                      <table width="100%" class="table table-stripped" cellpadding="6" cellspacing="1">
                       <caption class="text-center"><font size="+1" style="font-family:'Arial'"> <strong><?php echo display('inventory_ledger_report')?>(<?php echo display('from')?> <?php echo (!empty($HeadName)?$HeadName:'') ?> <?php echo display('on')?> <?php echo (!empty($FromDate)?$FromDate:''); ?> <?php echo display('to')?> <?php echo (!empty($ToDate)?$ToDate:'');?>)</strong></font></caption>
                        ...
                        <tr class="table_head">
                            ...
                            <th align="right"><strong><?php echo display('transaction_type')?></strong></th>
                            <th class="text-center"><strong><?php echo display('account_head')?></strong></th>
                            <th width="11%" class="text-right"><strong><?php echo display('debit')?></strong></th>
                            <th width="11%" class="text-right"><strong><?php echo display('credit')?></strong></th>
                            <th class="text-right"><strong><?php echo display('balance')?></strong></th>
                        </tr>
                        <?php
                        $TotalCredit=0;
                        $TotalDebit=0;
