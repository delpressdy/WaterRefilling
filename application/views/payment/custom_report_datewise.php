...
<div class="content-wrapper">
	<section class="content-header">
	    ...
	    <div class="header-title">
	        <h1><?php echo display('transection_details_datewise')?></h1>
	        <small><?php echo display('transection_details')?></small>
	        <ol class="breadcrumb">
	            <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
	            <li><a href="#"><?php echo display('transection_details')?></a></li>
	            <li class="active"><?php echo display('transection_details')?></li>
	        </ol>
	    </div>
	</section>
