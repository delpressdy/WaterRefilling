                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <form action="<?php echo base_url('Ccustomer/paid_customer_search_item')?>" class="form-inline" method="post" accept-charset="utf-8">
	                           ...
	                           <?php foreach($all_paid_customer_list as $cust_list){
		                    ...
		                    <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
		                    	<thead>
									<tr>
                                        ...
                                        <?php
                                        if($this->permission1->method('paid_customer','update')->access() || $this->permission1->method('paid_customer','delete')->access()) { ?>
...
<script type="text/javascript">
	...
	{	
		...
		var x = confirm("<?php display('are_you_sure_to_delete')?>");
		if (x==true){
		$.ajax
	   ({
			type: "POST",
