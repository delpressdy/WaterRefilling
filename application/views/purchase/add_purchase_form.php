...
<div class="content-wrapper">
    <section class="content-header">
        <ol class="breadcrumb">
                ...
                <li><a href="#"><?php echo 'Refill Gallons' ?></a></li>
                <li class="active"><?php echo 'Refill'?></li>
            </ol>
    </section>
                    ...
                    <?php echo form_open_multipart('Cpurchase/insert_purchase',array('class' => 'form-vertical', 'id' => 'insert_purchase','name' => 'insert_purchase'))?>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <select name="paytype" class="form-control" required="" onchange="bank_paymet(this.value)">
                                                    <option value="1">Dumingag, Zamboanga Del Sur</option>
                                                </select>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="hidden" tabindex="3" class="form-control" name="chalan_no" placeholder="<?php echo display('invoice_no') ?>" id="invoice_no" value="<?php $id = rand(1000,9999); echo $id;; ?>" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive" style="margin-top: 10px">
                            <table class="table table-bordered table-hover" id="purchaseTable">
                                <thead>
                                    <tr>
                                            <th class="text-center" width="20%"><?php echo 'Item' ?><i class="text-danger">*</i></th> 
                                            <th class="text-center"><?php echo 'Batch #' ?> <i class="text-danger">*</i></th>
                                            <th class="text-center"><?php echo 'Stock' ?></th>
                                            <th class="text-center"><?php echo 'Refilled' ?> <i class="text-danger">*</i></th>
                                ...
                                <tbody id="addPurchaseItem">
                                    <tr>
                                        <td class="span3 manufacturer">
                                           <input type="text" name="product_name" required class="form-control product_name productSelection" onkeypress="product_pur_or_list(1);" placeholder="<?php echo 'Search Item' ?>" tabindex="5" >
                                ...
                                <tfoot>
                                    <tr>
                                            <input type="hidden" id="add_invoice_item" class="btn btn-info" name="add-invoice-item"  onClick="addPurchaseOrderField1('addPurchaseItem');" value="<?php echo display('add_new_item') ?>"  tabindex="11"/>
